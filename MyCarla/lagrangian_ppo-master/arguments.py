...
def get_args():
    ...
    parse.add_argument('--project-name', type=str, default='PPO-L-Carla-intersection', help='define the project name')
    parse.add_argument('--device', type=str, default='cpu')
    parse.add_argument('--seed', type=int, default=123, help='the random seeds')
    parse.add_argument('--env-name', type=str, default='carla-v0', help='the environment name')
