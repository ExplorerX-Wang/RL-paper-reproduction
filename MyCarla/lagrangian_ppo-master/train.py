...
class Train:
    ...
    def step(self):
        ...
        #state = self.convert_obs_dict_to_vector(state)
        for iteration in tqdm(range(1, 1 + self.n_iterations)):
            ...
            for t in range(self.horizon):
                ...
                next_state = self.convert_obs_dict_to_vector(next_state)
            ...
            eval_rewards, eval_costs = evaluate_model(self.agent, self.env, self.state_rms)
    ...
    def convert_obs_dict_to_vector(self, obs_dict):
