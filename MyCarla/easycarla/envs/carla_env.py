    ...
    def reset(self, start_point=None, end_point=None):
        ...
        while True:
            ...
            if self._try_spawn_ego_vehicle_at(transform):
                ...
                self.start_point = self.map.get_waypoint(transform.location, project_to_road=True, lane_type=carla.LaneType.Driving)
        ...
        self.end_point = random.choice(available_end_points)

        self.end_point = self.map.get_waypoint(self.end_point.location, project_to_road=True, lane_type=carla.LaneType.Driving)
        # self.world.debug.draw_point(
